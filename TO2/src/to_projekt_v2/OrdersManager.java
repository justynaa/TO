...
public class OrdersManager extends JFrame {
    ...
    public OrdersManager(String userName, String userType) throws SQLException {
        initComponents();
    ...
    private void jTableDisplayOrdersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDisplayOrdersMouseClicked
        ...
        Object endDateValue = model.getValueAt(i, 2);   //pobranie waartosci endDate zeby sprawdzic czy jest NULLEM
        jTextFieldID.setText(model.getValueAt(i, 0).toString().trim());
        jTextFieldStartDate.setText(model.getValueAt(i, 1).toString().trim());
        if(endDateValue != null){
            jTextFieldEndDate.setText(model.getValueAt(i, 2).toString().trim()); 
        }
        else{
            jTextFieldEndDate.setText(""); 
        }
        jTextFieldDescription.setText(model.getValueAt(i, 3).toString().trim());
        jTextFieldIDMechanik.setText(model.getValueAt(i, 4).toString().trim());
        jTextFieldIDSamochod.setText(model.getValueAt(i, 5).toString().trim()); 
        jTextFieldCost.setText(model.getValueAt(i, 6).toString().trim());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            order = new Order(jTextFieldStartDate.getText(), jTextFieldEndDate.getText(), jTextFieldDescription.getText(), 
            Integer.parseInt(jTextFieldIDMechanik.getText()), Integer.parseInt(jTextFieldIDSamochod.getText()), Double.parseDouble(jTextFieldCost.getText()));
            orderDAO.addNewOrderDAO(order, userType);
            DefaultTableModel model = (DefaultTableModel)jTableDisplayOrders.getModel();
            model.setRowCount(0);
            showOrdersInJTable();
        } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Niepoprawne dane. Spróbuj ponownie.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (savedID.equals(ID)) {
            try {
                order = new Order(Integer.parseInt(jTextFieldID.getText()), jTextFieldStartDate.getText(), jTextFieldEndDate.getText(),  
                jTextFieldDescription.getText(), Integer.parseInt(jTextFieldIDMechanik.getText()), Integer.parseInt(jTextFieldIDSamochod.getText()),  
                Double.parseDouble(jTextFieldCost.getText()));
                orderDAO.updateOrderDataDAO(order);
                DefaultTableModel model = (DefaultTableModel)jTableDisplayOrders.getModel();
                model.setRowCount(0);
                showOrdersInJTable();
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdersManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
